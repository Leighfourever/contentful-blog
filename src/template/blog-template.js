...
const BlogTemplate = ({ data }) => {
  ...
  return (
    <Layout>
      <div className="mt-10">
        <h1 className="font-bold block mt-10 text-2xl md:text-3xl break-words mb-3 capitalize">
          {blogTitle}
        </h1>
        ...
        <div
          className="max-w-full mt-10 m-auto mb-2 prose prose-pre:bg-slate-50 prose-pre:text-black"
